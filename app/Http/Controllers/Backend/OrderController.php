...
class OrderController extends Controller
{
    ...
    public function ReturnRequest()
    {
        ...
        $orders = Order::where('return_status', '!=', null)->orderBy('id', 'DESC')->get();
        return view('backend.order.return_request', compact('orders'));
    ...
    public function ReturnRequestApprove($order_id)
    {
        ...
        Order::where('id', $order_id)->update(['return_status' => 2,
            'status' => 'return',]);
    ...
    public function CancelRequest()
    {
        ...
        $orders = Order::where('cancel_status', '!=', null)->orderBy('id', 'DESC')->get();
        return view('backend.order.cancel_request', compact('orders'));
    ...
    public function CancelRequestApprove($order_id)
    {
        ...
        Order::where('id', $order_id)->update(['cancel_status' => 2,
            'status' => 'cancel',]);
