                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="detail.html"><img  src="{{asset($item-> product_thumbnail)}}" alt="" style="width: 200px;height: 200px"></a> </div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    @if($item-> discount_price == null)
                                                        <div class="product-price"> <span class="price"> {{$item-> selling_price}} $</span>
                                                            @else
                                                    <div class="product-price"> <span class="price"> {{$item-> discount_price}} $</span> <span class="price-before-discount">{{$item-> selling_price}} $</span> </div>
                                                            @endif
                                                            <!-- /.product-price -->
