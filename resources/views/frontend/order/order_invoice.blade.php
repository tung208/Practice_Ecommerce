...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            ...
            <h2 style="color: green; font-size: 26px;"><strong>NetKo Solution</strong></h2>
        </td>
        <td align="right">
            <pre class="font">
               NetKo Office
               Email:nguyentung9196@gmail.com <br>
               Phone: 0969616268 <br>
               84 Duy Tan Street, Ha Noi <br>
...
<table width="100%" style="background: #F7F7F7; padding:0px 5px 0px 5px;" class="font">
    <tr>
        <td>
