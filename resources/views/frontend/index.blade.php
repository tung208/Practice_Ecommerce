                        ...
                        <div class="item" style="background-image: url({{$slider-> slider_img}});">
                            <div class="container-fluid">
                                <div class="caption bg-color vertical-center text-left">
                                    ...
                                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slider-> title}}</span> </div>
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="detail.html"><img  src="{{$item -> category_icon}}" alt=""></a> </div>
                                                    <!-- /.image -->
...
{{--                                                    <div class="tag new"><span>new</span></div>--}}
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">{{$item -> category_name_en}}</a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                                    <div class="product-price"> <span class="price">({{count($category)}} items) </span> {{--<span class="price-before-discount">$ 800</span>--}} </div>
                                                    <!-- /.product-price -->
