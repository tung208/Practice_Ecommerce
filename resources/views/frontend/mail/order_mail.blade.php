                                                        ...
                                                        <td align="center"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr style="background: #e2e2e2;">
                                                                    <td class="col-md-1">
                                                                        <label for=""> Image </label><p> </p>
                                                                    </td>

                                                                    <td class="col-md-3">
                                                                        <label for=""> Product Name </label><p> </p>
                                                                    </td>

                                                                    <td class="col-md-3">
                                                                        <label for=""> Product Code </label><p> </p>
                                                                    </td>


                                                                    <td class="col-md-2">
                                                                        <label for=""> Color </label><p> </p>
                                                                    </td>

                                                                    <td class="col-md-2">
                                                                        <label for=""> Size </label><p> </p>
                                                                    </td>

                                                                    <td class="col-md-1">
                                                                        <label for=""> Quantity </label><p> </p>
                                                                    </td>

                                                                    <td class="col-md-1">
                                                                        <label for=""> Price </label><p> </p>
                                                                    </td>
                                                                ...
                                                                @foreach($orderItem as $o)
                                                                    <tr>
                                                                        ...
                                                                        <td class="col-md-3">
                                                                            <label
                                                                                for=""> {{ $o->product->product_name_en }} </label>
                                                                        </td>


                                                                        <td class="col-md-3">
                                                                            <label
                                                                                for=""> {{ $o->product->product_code }} </label>
                                                                        </td>

                                                                        <td class="col-md-2">
                                                                            <label for=""> {{ $o->color }} </label>
                                                                        </td>

                                                                        <td class="col-md-2">
                                                                            <label for=""> {{ $o->size }} </label>
                                                                        </td>

                                                                        <td class="col-md-1">
                                                                            <label for=""> {{ $o->qty }} </label>
                                                                        </td>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">
                                        © 2023 NetKo Solution. All rights reserved.</p>
