        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Company Info Setting Page </h4>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{ route('admin.updateProfileCompany') }}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" id="image" name="logo" class="form-control" > </div>
                                                </div>
                                                <div class="form-group">
                                                 <img id="showImage" src="{{(!empty($setting-> logo))? url($setting->logo): url('upload/no_image.jpg')}}" style=" width: 153px; height: 64px;">
                                                </div>
