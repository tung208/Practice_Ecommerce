                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($sliders as $item)
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <a href="{{ route('admin.editSlider',$item->id) }}" class="btn btn-info btn-sm" title="Edit Data"><i class="fa fa-pencil"></i> </a>

                                                <a href="{{ route('delete.slider',$item->id) }}" class="btn btn-danger btn-sm" title="Delete Data" id="delete">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('admin.storeSlider') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" style=" width: 250px; height: 82px;">
                                    </div>
