        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.changeProfileCompany')? 'active':'' }}"><a
                            href="{{ route('admin.changeProfileCompany') }}"><i class="ti-more"></i>Change Profile
                            Company </a></li>
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.viewSlider')? 'active':'' }}"><a
                            href="{{ route('admin.viewSlider') }}"><i class="ti-more"></i>Manager Slider </a></li>
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.viewCategory')? 'active':'' }}"><a
                            href="{{ route('admin.viewCategory') }}"><i class="ti-more"></i>All Category</a></li>
                    <li class="{{ ($route == 'admin.viewSubCategory')? 'active':'' }}"><a
                            href="{{ route('admin.viewSubCategory') }}"><i class="ti-more"></i>All SubCategory</a></li>
                    <li class="{{ ($route == 'admin.viewSubSubCategory')? 'active':'' }}"><a
                            href="{{ route('admin.viewSubSubCategory') }}"><i class="ti-more"></i>All
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.viewCategory')? 'active':'' }}"><a
                            href="{{ route('admin.viewBrand') }}"><i class="ti-more"></i>All Brand</a></li>
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.viewProduct')? 'active':'' }}"><a
                            href="{{ route('admin.viewProduct') }}"><i class="ti-more"></i>All Product</a></li>
            ...
            <li class="treeview ">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'admin.viewProduct')? 'active':'' }}"><a
                            href="{{ route('view.blog.category') }}"><i class="ti-more"></i>All Blog Category</a></li>
                    <li class="{{ ($route == 'list.blog')? 'active':'' }}"><a href="{{ route('list.blog') }}"><i
                                class="ti-more"></i>All Blog </a></li>

                    <li class="{{ ($route == 'add.blog')? 'active':'' }}"><a href="{{ route('add.blog') }}"><i
                                class="ti-more"></i>Add Blog</a></li>
