...
{{--        @endif--}}
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'admin.changeProfileCompany')? 'active':'' }}"><a href="{{ route('admin.changeProfileCompany') }}"><i class="ti-more"></i>Change Profile Company </a></li>
          ...
          <li class="treeview ">
              ...
              <ul class="treeview-menu">
                  <li class="{{ ($route == 'admin.viewSlider')? 'active':'' }}"><a href="{{ route('admin.viewSlider') }}"><i class="ti-more"></i>Manager Slider </a></li>
